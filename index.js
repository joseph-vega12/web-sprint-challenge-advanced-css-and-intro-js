...
console.log(artists[8].name) //before
artists[8].name = "Vincent Van Gogh ";
console.log(artists[8].name) //after
...
console.log(addArtist(artists, 20, "Joseph", 1999, "milk", "greek", "Hey hey hey hye hyehy heyhe yh eyheyheyhey "));

function createMenuItem(name, price, category) {

  return { name, price, category };//more menu items with the sme format as the items above
}
